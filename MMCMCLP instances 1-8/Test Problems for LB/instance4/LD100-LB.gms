...
,c3(i,l,t),c4(i,l,t),c5(i,l,t),c41(i,l,t),c51(i,l,t),c61(i,t),c31(i,l,t),c81(i,j,l,t),c11(i,j,l,t);

objfun..         bound=e=sum((i,j,l,t),g(i,j)*d(j,l,t)*x(i,j,l,t))+sum((j,l,t),u(j,l,t)*(1-sum(i,x(i,j,l,t))))
+sum((i,j,l,t),u2(i,t)*(-d(j,l,t)*x(i,j,l,t)))-sum((i,l,k,t),h(i,l,k,t)*y(i,l,k,t))+sum((i,t),u2(i,t)*cap(i)*z.l(i));

objfun1..        obj=e=sum((i,t),u2(i,t)*cap(i)*z(i)) ;
objfun2..        obj2=e=-sum((i,l,k,t),h(i,l,k,t)*y.l(i,l,k,t))+sum((i,j,l,t),g(i,j)*d(j,l,t)*x2(i,j,l,t));

c11(i,j,l,t)..  x(i,j,l,t)=l=sum(k,y(i,l,k,t));

c31(i,l,t)..     sum(k,y(i,l,k,t))=l=z.l(i);
...
c51(i,l,t)..     sum(j,d(j,l,t)*x2(i,j,l,t))=g=sum(k,cpl(l,k)*y.l(i,l,k,t));
c61(i,t)..       sum((l,j),d(j,l,t)*x2(i,j,l,t))=l=cap(i)*z.l(i);
c8(j,l,t)..      sum(i,x2(i,j,l,t))=l=1;

model DMC/objfun,c11,c4,c5,c31/;
model ldual/objfun1,c7/;

model DMC2/objfun2,c41,c8,c61,c51/;
...
stepsize = theta*(bestbound-lowerbound2)/norm;
*
* update duals u
*
...
*if((results(iter,'upperbound')=results(iter-1,'upperbound')) and (results(iter,'upperbound')=results(iter-2,'upperbound')),
*display "converged";
*continue =0;
*);
